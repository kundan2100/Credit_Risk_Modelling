...
# Save the trained model
joblib.dump(xgb_classifier, r'D:\\Credit_Risk_Modelling\\xgb_model.pkl')

print("Model trained and saved successfully.")

# Save the label encoder classes
np.save(r'D:\\Credit_Risk_Modelling\\label_encoder_classes.npy', label_encoder.classes_)


# Save the final df_encoded DataFrame to a CSV file
output_file_path = "D:\\Credit_Risk_Modelling\\df_encoded.csv"
